...
- A runnable, project-free Minimal Host with Environment manifests, lifecycle CLI, immutable Skill snapshots, honest isolation reporting, and a fixed broker for short-lived Codex model access
