...
1. Extract snapshot, optimistic-message and active-Turn reconciliation from Minimal Host into a transport-injected controller.
2. Move event replay, reconnect and authoritative polling into the same application layer.
