...
- `FilesystemResourceStore` staging, atomic records, Session authorization, commit, external-handle registration, usage inspection, and side-effect-free expired-draft planning;
...
Still unresolved or unimplemented: artifact promotion, quarantine/purge, consumer compatibility adapters, and migration of existing stores. No cleanup is enabled by this slice.
...
6. Add transient-output promotion for Browser screenshots, generated downloads, and visualizations.
7. Add usage inspection and collection planning. Ship dry-run before quarantine; ship quarantine before purge.
